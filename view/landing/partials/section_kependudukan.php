...
?>
<section id="data" class="w-full py-section-gap px-margin-mobile lg:px-margin-desktop bg-surface relative reveal">
<div class="max-w-container-max mx-auto">
<div class="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
<div class="lg:col-span-7 flex flex-col gap-6">
<span class="font-label-mono text-label-mono text-primary">TRANSPARANSI DATA</span>
<h2 class="font-headline-xl text-headline-xl-mobile lg:text-headline-xl text-on-surface">Data Penduduk,<br/>Per Dusun.</h2>
...
<div class="bg-glass-fill backdrop-blur-md rounded-[20px] border border-glass-border p-4 md:p-stack-lg overflow-hidden relative">
...
<th class="py-3 px-3 font-medium">Dusun</th>
...
<td class="py-3 px-3 font-medium text-on-surface"><?= e($d['nama_dusun']) ?></td>
<td class="py-3 px-3 text-right text-label-mono font-label-mono"><?= formatAngka($d['jumlah_laki']) ?></td>
<td class="py-3 px-3 text-right text-label-mono font-label-mono"><?= formatAngka($d['jumlah_perempuan']) ?></td>
<td class="py-3 px-3 text-right text-label-mono font-label-mono"><?= formatAngka($d['jumlah_kk']) ?></td>
<td class="py-3 px-3 text-right text-label-mono font-label-mono text-primary"><?= formatAngka($d['jumlah_jiwa']) ?></td>
</tr>
<?php endforeach; ?>
<tr class="bg-surface-container-highest/60">
<td class="py-3 px-3 font-bold text-on-surface">Total</td>
<td class="py-3 px-3 text-right text-label-mono font-label-mono font-bold"><?= formatAngka($totalLaki) ?></td>
<td class="py-3 px-3 text-right text-label-mono font-label-mono font-bold"><?= formatAngka($totalPerempuan) ?></td>
<td class="py-3 px-3 text-right text-label-mono font-label-mono font-bold"><?= formatAngka($totalKk) ?></td>
<td class="py-3 px-3 text-right text-label-mono font-label-mono font-bold text-primary"><?= formatAngka($totalJiwa) ?></td>
</tr>
</tbody>
</table>
</div>
...
<div class="bg-glass-fill backdrop-blur-md rounded-[24px] border border-glass-border p-6 md:p-8 shadow-2xl relative w-full overflow-hidden">
...
<h4 class="font-headline-md text-on-surface">Komposisi Penduduk</h4>
